...
const Faq = () => {
  return (
    <>
    <section className="faq_section section_space pb-0" id="id_ico_faq_section">
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  <p>
                    You can participate in the CoinPay ICO, simply register on
                    our platform, complete the KYC (Know Your Customer) process,
                    and follow the instructions to purchase tokens during the
                    ICO period, Once registered buy tokens with secure payments.
                  </p>
