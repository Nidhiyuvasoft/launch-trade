  ...
  return (
    <>
      <section
        ...
        className="ico_about_section section_space pb-0 pt-0 section_decoration"
      >
            ...
            <div className="col-lg-6">
              ...
              <ul className="about_ico_block unordered_list_block">
                <li
                  ...
                  data-aos-delay={100}
                >
                  <h3 className="title_text">What is an LaunchTrade.ai?</h3>
                  <p className="info_description mb-0">
                    Coinpay is a decentralized digital currency enabling
                    peer-to-peer transactions without intermediaries. Introduced
                    in 2022 by Satoshi Nakamoto, it is the first cryptocurrency,
                    known for secure and borderless exchanges.
                  </p>
                </li>
                <li
                  data-aos="fade-up"
                  ...
                  data-aos-delay={200}
                >
                  <h3 className="title_text">Why it’s need?</h3>
                  <p className="info_description mb-0">
                    Coinpay is needed to provide a decentralized alternative to
                    traditional financial systems. It allows secure,
                    transparent, and borderless transactions without relying on
                    banks or governments. This empowers individuals with
                    financial freedom,
                  </p>
                </li>
                <li
                  ...
                  data-aos-delay={300}
                >
                  <h3 className="title_text">Why wealth?</h3>
                  <p className="info_description mb-0">
                    Coinpay is considered a form of wealth due to its scarcity,
                    decentralization, and potential for long-term value growth.
                    Its limited supply (21 million coins) makes it a store of
                    value, while its global accessibility offers financial
                    independence.
                  </p>
                </li>
              </ul>
            ...
            <div className="col-lg-5 d-lg-flex flex-lg-column-reverse">
              <ul className="about_ico_block unordered_list_block">
                <li
                  ...
                  data-aos-delay={100}
                >
                  <h3 className="title_text">Market Opportunity</h3>
                  <p className="info_description mb-0">
                    Coinpay's market opportunity stems from its growing adoption
                    as a digital asset and payment method. As interest from
                    investors, businesses, and institutions increases, It’s
                    finance and retail is expanding, boosting its value and
                    utility.
                  </p>
                </li>
              </ul>
              <div className="ico_about_image text-center">
                ...
                <div className="coin_image">
                  <img src="assets/images/about/trial.png" alt="About Image" />
                </div>
              </div>
            </div>
          </div>
